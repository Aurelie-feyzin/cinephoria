...
/** https://github.com/coopTilleuls/CoopTilleulsForgotPasswordBundle/blob/2.0/docs/usage.md */
final class ForgotPasswordEventSubscriber implements EventSubscriberInterface
{
    public function __construct(private readonly Mailer $mailer, private readonly ValidatorInterface $validator, private readonly UserRepository $userRepository, private readonly Security $security,
    ...
    public function onCreateToken(CreateTokenEvent $event): void
    {
        ...
        $this->mailer->sendForgotPassword($user, $passwordToken->getToken());
    }
